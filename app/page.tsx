          ...
          <Card className="shadow-sm hover:shadow-md transition-shadow duration-200">
            <CardContent className="p-6">
              <p className="text-gray-700">
                ...
                learning algorithms to identify patterns in spending, saving, and earning that traditional credit
                bureaus miss. We securely connect to users' financial accounts to gather data, always with explicit
                permission and the highest privacy standards. Our technology has been validated through partnerships
                with leading financial institutions who recognize the value of our more nuanced approach to risk
                assessment. The result is a win-win: lenders reduce default rates while expanding their customer base.
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="shadow-sm hover:shadow-md transition-shadow duration-200">
            <CardContent className="p-6">
              <p className="text-gray-700">
                ...
                score, but actionable insights on how to improve financial health. We provide personalized
                recommendations tailored to each user's unique situation, helping them build stronger credit over time.
                Our community of users reports an average 30% improvement in credit access within six months of joining
                AltCredit, demonstrating the real-world impact of our innovative approach.
              </p>
            </CardContent>
          </Card>
        </div>
